import LeaderboardOptions from '@/lib-components/LeaderboardOptions';

export default {
  title: 'Library/LeaderboardOptions',
  component: LeaderboardOptions,
  argTypes: {},
};

const Template = (args) => ({
  components: { LeaderboardOptions },
  setup() {
    return { args };
  },
  data() {
    return {
      selectedPlayers: args.selectedPlayers,
      selectedRegion: args.selectedRegion,
      selectedGraphOption: args.selectedGraphOption,
    };
  },
  template: `<div > 
              <LeaderboardOptions v-bind="args" 
                v-model:selectedPlayers="selectedPlayers" 
...
const players = [
  ...
  },
  {
    ...
    wins: 937,
    matches: 1557,
    favorite_deck: 'CMBAEBIHBMHAMBAHAMOCKJRWNUBACBIHA4DAIBYNHNEEYZTZAEBAIBY2HY',
    selected_banner_card: null,
    selected_banner_color: null,
  },
  {
  ...
  },
  {
    ...
    wins: 1180,
    matches: 2242,
    favorite_deck: 'CMBACBIHBYDQIBYDBUOCKJRWNUBAEBIHA4FQKBAHHNEEY6DZAEBAIBZ6MY',
    selected_banner_card: null,
    selected_banner_color: null,
  },
  {
...
Default.args = {
  ...
  selectedPlayers: [],
  selectedRegion: null,
  selectedGraphOption: 'totalPlayers',
  updatedAt: 27997612,
  isGraphShown: false,
};

export const RegionSelected = Template.bind({});
RegionSelected.args = {
  players,
  selectedPlayers: [],
...
export const PlayerSelected = Template.bind({});
PlayerSelected.args = {
  players,
  selectedPlayers: [8821],
  selectedRegion: 'americas',
  selectedGraphOption: 'totalPlayers',
  updatedAt: 27997600,
  isGraphShown: false,
...
export const PlayersSelected = Template.bind({});
PlayersSelected.args = {
  players,
  selectedPlayers: [8821, 2259],
  selectedRegion: 'americas',
  selectedGraphOption: 'totalPlayers',
  updatedAt: 27997611,
  isGraphShown: false,
...
export const GraphDefault = Template.bind({});
GraphDefault.args = {
  players,
  selectedPlayers: [],
  selectedRegion: null,
...
export const GraphRegionSelected = Template.bind({});
GraphRegionSelected.args = {
  players,
  selectedPlayers: [],
  selectedRegion: 'americas',
  selectedGraphOption: 'totalPlayers',
...
export const GraphPlayerSelected = Template.bind({});
GraphPlayerSelected.args = {
  players,
  selectedPlayers: [8821],
  selectedRegion: 'americas',
  selectedGraphOption: 'lp',
  updatedAt: 27997600,
  isGraphShown: true,
};

export const GraphPlayersSelected = Template.bind({});
GraphPlayersSelected.args = {
  players,
  selectedPlayers: [8821, 2259],
  selectedRegion: 'americas',
  selectedGraphOption: 'lp',
