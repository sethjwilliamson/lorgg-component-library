import CardItemLinkWrapper from '@/lib-components/CardItemLinkWrapper';

export default {
  title: 'Library/CardItemLinkWrapper',
  component: CardItemLinkWrapper,
  argTypes: {},
};

const Template = (args) => ({
  components: { CardItemLinkWrapper },
  setup() {
    return { args };
  },

  template: `<div style="width: 320px">
              <card-item-link-wrapper v-bind="args" />
            </div>`,
});
