...
find $COMPONENT_FILE -type f  -exec sed -i '' -e "s/CopyMeComponent/$COMPONENT_NAME/g" -e "s/copyMeComponent/$COMPONENT_NAME_LOWERCASE/g" {} +
...
sed -i '' -e "s/CopyMeComponent/$COMPONENT_NAME/g" "stories/$COMPONENT_NAME.stories.js"
